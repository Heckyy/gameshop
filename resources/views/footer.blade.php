<div style="clear:both" class="panel panel-default">
    <div class="panel-body container text-center">
        <p class="mb-4">
            Jika mau menjual barang disini silahkan contact langsung ke admin.
            Senin-Jumat(9am-6pm)
        </p>
    </div>
    <footer class="footer-area">
        <div class="footer-top-3 black-bg pt-75 pb-25 footer">
            <div class="container">
                <div class="row">
                        ...
                        <div class="footer-widget mb-40">
                            ...
                            <div class="footer-info-wrapper-2">
                                ...
                                <div class="footer-address-electro">
                                    ...
                                    <div class="footer-info-content2">
                                        <p><a href="#">gamingnesia@gmail.com</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="footer-widget mb-40">
                            ...
                            <div class="footer-widget-content-3">
                                <ul>
                                    ...
                                    <li><a href="/myorders"> Payment</a></li>
